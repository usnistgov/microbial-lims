# Contributing to microbial-experiment-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
microbial-experiment-schema. These guidelines are not strict rules.
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the microbial-experiment-schema technical leads
...
[issues]: https://github.com/usnistgov/microbial-experiment-schema/issues/
[pulls]: https://github.com/usnistgov/microbial-experiment-schema/pulls/

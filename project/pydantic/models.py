...
class Experiment(ConfiguredBaseModel):
    ...
    elab_experiment: ELabExperiment = Field(..., title="ELabFTW Experiment", description="""A self-reference to this experiment record""", json_schema_extra = { "linkml_meta": {'alias': 'elab_experiment',
         'annotations': {'elabftw_user_input': {'tag': 'elabftw_user_input',
                                                'value': False}},
         'domain_of': ['Experiment']} })
